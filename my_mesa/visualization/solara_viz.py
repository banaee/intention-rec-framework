...
import my_mesa.visualization.components.altair as components_altair
import my_mesa.visualization.components.matplotlib as components_matplotlib
from my_mesa.visualization.UserParam import Slider
...
def SolaraViz(
    ...
    reactive_mytext = solara.use_reactive("Hello world")
    ...
    with solara.Sidebar():
        ...
        # --------------------------------------------------------------
        # MY TEST CODE on how to use reactive
        # --------------------------------------------------------------
        # with solara.Card("Choose", margin=1, elevation=2):
        #     solara.InputText("Enter some text", 
        #                      value=reactive_mytext,
        #                      continuous_update=True)
        #     with solara.Row():
        #         solara.Button("Clear", on_click=lambda: reactive_mytext.set("")) 
